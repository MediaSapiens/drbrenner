 ...
 */
$TYPO3_CONF_VARS['SC_OPTIONS']['t3lib/class.t3lib_pagerenderer.php']['render-postProcess'][] = 'EXT:html5boilerplate4/Classes/class.tx_html5boilerplate4.php:tx_html5boilerplate4->pageRendererPostProcessHook';
?>