 ...
 *  Copyright notice
 *
 *  (c) 2011 html5boilerplate4 for TYPO3-Team <http://forge.typo3.org/projects/extension-html5boilerplate4>
 *  All rights reserved
 *
...
/**
 * html5boilerplate4 main class
 * Includes a render postProcess hook of t3lib_PageRenderer to manipulate
 * marker for html5boilerplate4 usage. E.g. a custom <html>-Tag or a 
 * X-UA-Compatible parameter directly after the <meta charset>-tag
 *
 * @package TYPO3
 * @subpackage EXT:html5boilerplate4
 */
class tx_html5boilerplate4 {

	/**
	 * postProcess-hook of t3lib_PageRenderer to manipulate some marker for correct html5boilerplate4 usage
	 * 
	...
	public function pageRendererPostProcessHook($params, $pObj){
		...
		$conf = $GLOBALS['TSFE']->config['config']['html5boilerplate4.'];
...
if (defined('TYPO3_MODE') && isset($GLOBALS['TYPO3_CONF_VARS'][TYPO3_MODE]['XCLASS']['ext/html5boilerplate4/Classes/class.tx_html5boilerplate4.php'])) {
	include_once($GLOBALS['TYPO3_CONF_VARS'][TYPO3_MODE]['XCLASS']['ext/html5boilerplate4/Classes/class.tx_html5boilerplate4.php']);
}
?>